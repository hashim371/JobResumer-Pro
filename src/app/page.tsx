...
const companyLogos: { [key: string]: React.ReactNode } = {
    ...
    Netflix: (
       <svg xmlns="http://www.w3.org/2000/svg" width="80" height="34" viewBox="0 0 168 30" fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M12.721 29.032H25.044V0H12.721V29.032ZM36.175 0V22.2L53.722 0H36.175ZM65.816 29.032H78.14V0H65.816V29.032ZM92.176 14.285L80.463 0H98.335L104.14 8.572L110.177 0H127.813L115.868 14.285L128 29.032H110.364L104.14 19.52L97.915 29.032H80.225L92.176 14.285ZM155.021 0L137.474 29.032H155.253L168 0H155.021Z" fill="#E50914"/></svg>
    ),
    Facebook: (
