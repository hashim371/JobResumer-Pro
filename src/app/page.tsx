...
const companyLogos: { [key: string]: React.ReactNode } = {
    ...
    Apple: (
      <svg xmlns="http://www.w3.org/2000/svg" width="30" height="34" viewBox="0 0 24 24" fill="currentColor"><path d="M17.47,15.63a5,5,0,0,1-1.39,3.5,4.33,4.33,0,0,1-3.3,1.6,2.6,2.6,0,0,1-2.21-1.22,2.5,2.5,0,0,1-.39-1.25,4.3,4.3,0,0,1,.87-2.73,6.06,6.06,0,0,1,2-1.6,9.15,9.15,0,0,0,1.27-.89,1.52,1.52,0,0,0,.43-1,1.29,1.29,0,0,0-1.39-1.35,2.1,2.1,0,0,0-1.92,1.22,1,1,0,0,1-1.84-.78,3.22,3.22,0,0,1,3.24-2.61,3.4,3.4,0,0,1,3.78,3.53,4.13,4.13,0,0,1-1.12,2.83,5.1,5.1,0,0,0-1,1.18,1.3,1.3,0,0,0-.07.69,1.4,1.4,0,0,0,1.58,1.28,1.13,1.13,0,0,0,.82-.3,0.88,0.88,0,0,1,1.56.66A4,4,0,0,1,17.47,15.63Z" /><path d="M13,3.5A2.43,2.43,0,0,1,14.6,2a2.38,2.38,0,0,1,1.71.69A8.11,8.11,0,0,0,12.5,5.6,8.23,8.23,0,0,0,13,3.5Z" /></svg>
    ),
    Amazon: (
    ...
    Facebook: (
      <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="110" height="34" viewBox="0 0 48 48"><linearGradient id="Ld6sqrtcxMyckEl6oeadsa_uLSVCDQ_1" x1="9.993" x2="40.615" y1="9.993" y2="40.615" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#2aa4f4"></stop><stop offset="1" stop-color="#007ad9"></stop></linearGradient><path fill="url(#Ld6sqrtcxMyckEl6oeadsa_uLSVCDQ_1)" d="M24,4C12.954,4,4,12.954,4,24s8.954,20,20,20s20-8.954,20-20S35.046,4,24,4z"></path><path fill="#fff" d="M26.707,29.301h5.176l0.813-5.559h-5.989v-3.662c0-1.719,0.984-3.223,3.223-3.223h3.194V12.46c-0.577-0.078-1.797-0.248-4.102-0.248c-4.814,0-7.636,2.542-7.636,8.334v3.919h-4.187v5.559h4.187v12.16h5.484V29.301z"></path></svg>
    ),
};
