...
export const ResumePreview = ({ templateId, data: initialData, isClickable = true, templates: allTemplates }: ResumePreviewProps) => {
  ...
  if (!template) {
    return <div className={cn(parentClass, "flex items-center justify-center text-red-500")}><p>Template '{templateId}' not found.</p></div>;
  }
  
  // For original hardcoded templates, use the switch statement.
  if (!template.style) {
    const ContactLink = ({ type, value, children, className = '' }: { type: 'email' | 'website'; value: string, children?: React.ReactNode, className?: string }) => {
      ...
      switch (templateId) {
        case 'new-york':
            return (
                <div className={cn(parentClass, "p-10 font-serif bg-white text-gray-800 text-[11pt] leading-relaxed")}>
                    ...
                    <div className="mb-6">
                        ...
                        {experience?.map((exp: any, i: number) => (
                            <div key={i} className="mb-4">
                                ...
                                <p className="mt-1 text-gray-700 text-xs leading-normal">{exp.description}</p>
                            </div>
                        ))}
                    </div>
        ...
        case 'cairo':
        return (
            <div className={cn(parentClass, "p-10 font-body bg-white text-slate-800 text-sm")}>
                <h1 className="text-3xl font-bold font-headline text-slate-900">{personalInfo?.name}</h1>
                <p className="text-lg text-slate-600 font-medium mb-4">{personalInfo?.role}</p>
            ...
            return (
                <div className={cn(parentClass, "p-10 font-serif bg-white text-gray-900 text-[10.5pt] leading-normal")}>
                    <div className="text-center">
                        ...
                        <div className="text-xs text-gray-500 mt-4 flex justify-center items-center flex-wrap gap-x-3 gap-y-1">
                            {personalInfo?.location && <span>{personalInfo.location}</span>}
                    ...
                    <div className="mt-8">
                        ...
                        <p className="text-center text-xs leading-normal">{summary}</p>
                    </div>
                    ...
                    <div className="mt-6">
                        ...
                        {experience?.map((exp: any, i: number) => (
                            <div key={i} className="mb-4">
                                ...
                                <p className="mt-0.5 text-gray-800 text-xs leading-normal">{exp.description}</p>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="mt-6">
                        ...
                        <p className="text-center text-xs">{skills?.map((skill: any) => skill.name).join(' &bull; ')}</p>
                    </div>
                </div>
            )
        ...
        case 'shanghai':
            return (
                <div className={cn(parentClass, "p-10 font-body bg-white text-gray-800 text-sm")}>
                    ...
                    <div className="mt-6">
                        ...
                        {experience?.map((exp: any, i: number) => (
                            ...
                            <div className="col-span-1 text-xs text-gray-600">
                                <p className="whitespace-nowrap font-semibold">{exp.startDate} - {exp.endDate}</p>
                                <p>{exp.company}</p>
                            </div>
        ...
        case 'seoul':
            return (
                <div className={cn(parentClass, "p-10 font-body bg-white text-gray-700 text-sm")}>
                    <header className="text-center mb-8 pb-4">
                        ...
                        <div className="mt-4 border-b-2 border-teal-500 w-24 mx-auto"></div>
                    </header>

                    <div className="flex justify-center flex-wrap text-xs gap-x-6 gap-y-2 mb-8">
                    ...
                    <div className="mb-6">
                        ...
                        {experience?.map((exp: any, i:number) => (
                            <div key={i} className="mb-4">
                                ...
                                <p className="mt-1 text-xs leading-normal">{exp.description}</p>
                            </div>
                        ))}
                    </div>
                ...
                <div className={cn(parentClass, "p-10 font-body bg-white text-gray-800 text-sm")}>
                    ...
                    <div className="mt-8">
                        ...
                        {experience?.map((exp: any, i: number) => (
                            ...
                            <p className="mt-1 leading-relaxed text-xs text-center">{exp.description}</p>
                            </div>
                        ))}
                    </div>
        ...
        case 'stockholm':
        return (
            <div className={cn(parentClass, "p-10 font-body bg-sky-950 text-white text-sm")}>
            <div className="text-center mb-8">
            ...
            <div className="mb-6">
                ...
                <p className="text-sky-100 text-xs leading-normal">{summary}</p>
            </div>
            ...
            <div className="mb-6">
                ...
                <div key={i} className="mb-4">
                    ...
                    <p className="mt-1 text-sky-200 text-xs leading-normal">{exp.description}</p>
                </div>
                ))}
            </div>
            ...
            <div className="grid grid-cols-2 gap-x-12">
                ...
                {education?.map((edu: any, i: number) => (
                    ...
                    <p className="text-sky-200 text-xs">{edu.school}</p>
        ...
        case 'warsaw':
            ...
            <div className={cn(parentClass, "font-body bg-white text-slate-800 text-sm")}>
                <div className="bg-gray-800 text-white p-8 mb-8">
                    ...
                    <div className="flex flex-wrap justify-start items-center mt-4 text-xs text-gray-300 gap-x-4 gap-y-1">
                        {personalInfo?.phone && <span>{personalInfo.phone}</span>}
                        {personalInfo?.email && <ContactLink type="email" value={personalInfo.email} />}
                        {personalInfo?.location && <span>{personalInfo.location}</span>}
                        {personalInfo?.website && <ContactLink type="website" value={personalInfo.website} />}
                ...
                <div className={cn(parentClass, "font-body bg-gray-900 text-white text-sm flex")}>
                    ...
                    <div className="w-2/3 p-10">
                        <section className="mb-6">
                            ...
                            <p className="leading-relaxed text-gray-300 text-xs">{summary}</p>
                        </section>
                        <section className="mb-6">
                    ...
                    <section className="mt-6">
                        ...
                        {experience?.map((exp: any, i: number) => (
                            <div key={i} className="mb-3">
                                ...
                                <p className="text-xs text-gray-500">{exp.startDate} - {exp.endDate}</p>
                                <p className="text-xs mt-1 leading-normal">{exp.description}</p>
                            </div>
                        ))}
                    </section>
        ...
        case 'rio':
            return (
                <div className={cn(parentClass, "p-10 font-body bg-white text-gray-800 text-sm relative overflow-hidden")}>
        ...
        case 'zurich':
            return (
                <div className={cn(parentClass, "p-10 font-body bg-gray-50 text-gray-900 text-sm")}>
  ...
  // New logic for dynamically styled templates
  const { style } = template;
  const { layout, fontFamily, colors } = style;
  ...
  const MainContent = () => (
    <div className={cn(layout !== 'single-column' && "p-8")}>
      <section className="mb-6">
        <h2 className="text-lg font-bold uppercase tracking-wider mb-2" style={{ color: colors.primary }}>Summary</h2>
        <p className="text-xs leading-relaxed">{summary}</p>
      </section>
      <section>
        <h2 className="text-lg font-bold uppercase tracking-wider mb-2" style={{ color: colors.primary }}>Experience</h2>
        {experience?.map((exp: any, i: number) => (
          <div key={i} className="mb-4">
            <div className="flex justify-between items-baseline">
              <h3 className="text-md font-bold">{exp.jobTitle}</h3>
              <p className="text-xs whitespace-nowrap">{exp.startDate} - {exp.endDate}</p>
            </div>
            <h4 className="font-semibold italic" style={{ color: colors.primary }}>{exp.company}</h4>
            <p className="mt-1 leading-relaxed text-xs">{exp.description}</p>
          </div>
        ))}
      </section>
  ...
  const SidebarContent = () => (
    <div className="p-6">
      <section className="mb-6">
        <h2 className="text-sm font-bold uppercase tracking-wider mb-3" style={{ color: layout === 'two-column-right' ? colors.primary : colors.textOnPrimary }}>Contact</h2>
        <div className="text-xs space-y-2">
            <ContactItem icon={Mail} value={personalInfo?.email} href={`mailto:${personalInfo?.email}`} />
            <ContactItem icon={Phone} value={personalInfo?.phone} />
            <ContactItem icon={MapPin} value={personalInfo?.location} />
      ...
      <section className="mb-6">
        <h2 className="text-sm font-bold uppercase tracking-wider mb-3" style={{ color: layout === 'two-column-right' ? colors.primary : colors.textOnPrimary }}>Skills</h2>
        <div className="flex flex-wrap gap-2">
            {skills?.map((skill: any, i: number) => (
                <span key={i} className="text-xs px-2 py-1 rounded" style={{ backgroundColor: colors.primary, color: colors.textOnPrimary, opacity: 0.8 }}>{skill.name}</span>
            ))}
        </div>
      </section>
      <section>
        <h2 className="text-sm font-bold uppercase tracking-wider mb-3" style={{ color: layout === 'two-column-right' ? colors.primary : colors.textOnPrimary }}>Education</h2>
        {education?.map((edu: any, i: number) => (
  ...
  return (
    <>
        ...
        <div 
            className={cn(parentClass, "p-8 text-sm")}
            style={{ 
            ...
            {layout === 'single-column' && (
                <>
                    <header className="text-center mb-6">
                        <h1 className="text-4xl font-bold" style={{ color: colors.primary }}>{personalInfo?.name}</h1>
                        <p className="text-lg opacity-80">{personalInfo?.role}</p>
                    </header>
                    <MainContent />
            ...
            {layout !== 'single-column' && (
                <div className="flex h-full">
                    {layout === 'two-column-left' && (
                        <aside className="w-1/3 h-full" style={{ backgroundColor: colors.secondary, color: colors.textOnPrimary }}>
                            <div className="p-6 text-center mb-6">
                                <h1 className="text-2xl font-bold" style={{ color: colors.primary }}>{personalInfo?.name}</h1>
                                <p className="text-md opacity-80">{personalInfo?.role}</p>
                            </div>
                            <SidebarContent />
                        </aside>
                    )}
                    <main className="w-2/3 h-full">
                     ...
                     {layout === 'two-column-right' && (
                        <aside className="w-1/3 h-full" style={{ backgroundColor: colors.secondary }}>
                           <SidebarContent />
                        </aside>
                    )}
                </div>
